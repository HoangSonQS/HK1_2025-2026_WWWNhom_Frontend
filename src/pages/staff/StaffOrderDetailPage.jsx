...
import {
  getOrderById,
  updateOrderStatus,
} from "../../features/order/api/staffOrderService";
...
const StaffOrderDetailPage = () => {
  ...
  const handleUpdateStatus = async () => {
    ...
    // Gọi API cập nhật trạng thái (dùng orderService với jwtToken)
    setActionLoading(true);
    try {
      console.log('🔄 Staff updating order status:', { orderId: order.id, newStatus: selectedStatus });
